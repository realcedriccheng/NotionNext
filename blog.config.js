...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Cedric C.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不再只是一种玩笑', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://citriodora.life', // 网站地址
